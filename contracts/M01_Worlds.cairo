...
func start_game{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    let (local m02_addr) = IModuleController.get_module_address(
        controller, ModuleIds.M02_Resources
    );
    let (local m03_addr) = IModuleController.get_module_address(
        controller, ModuleIds.M03_Buildings
    );
...
func _check_can_build{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    local too_big_1 = is_le(pos_start + MAP_X_SIZE, 640);
    if (too_big_1 == 0) {
        return (0,);
    }
    ...
    local available = is_not_zero(index_1);
    if (available == 1) {
        return (0,);
    }
    ...
    local too_big_2 = is_le(pos_start + MAP_X_SIZE, 640);
    if (too_big_2 == 0) {
        return (0,);
    }
    ...
    local available = is_not_zero(index_2);
    if (available == 1) {
        return (0,);
    }
    ...
    local too_big_3 = is_le(pos_start + MAP_X_SIZE, 640);
    if (too_big_3 == 0) {
        return (0,);
    }

    local too_big_4 = is_le(pos_start + MAP_X_SIZE, 640);
    if (too_big_4 == 0) {
        return (0,);
    }
    ...
    local available = is_not_zero(index_3);
    if (available == 1) {
        return (0,);
    }
    ...
    local available = is_not_zero(index_4);
    if (available == 1) {
        return (0,);
    }
