...
namespace Data:
    ...
    func _compose_chain_destroyed{
        ...
        let comp = (1000000000000000 * values[0]) + (100000000000000 * values[1]) + (10000000000000 * values[2]) + (1000000000000 * values[3]) + (100000000000 * values[4]) + (100000 * values[10]) + (10000 * values[11]) + (1000 * values[12]) + (100 * values[13]) + (10 * values[14]) + values[15]
    ...
    func _compose_chain_build{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
        ...
        let comp = (1000000000000000 * values[0]) + (100000000000000 * values[1]) + (10000000000000 * values[2]) + (1000000000000 * values[3]) + (100000000000 * values[4]) + (1000000000 * building_type_id) + (1000000 * building_unique_id) + (100000 * 9) + (10000 * 9) + (100 * allocated_population) + (10 * level) + values[15]
