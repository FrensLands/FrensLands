...
@storage_var
func ERC721_token_uri_long(index: felt) -> (res: felt) {
}

@storage_var
func ERC721_token_uri_long_len() -> (res: felt) {
}
...
namespace ERC721 {
    ...
    func _set_token_uri_long{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        ERC721_token_uri_long_len.write(token_uri_len);

        if (token_uri_len == 0) {
            return ();
        }
        ERC721_token_uri_long.write(index=token_uri_len, value=[token_uri]);
        _set_token_uri_long(token_id, token_uri_len - 1, token_uri + 1);
