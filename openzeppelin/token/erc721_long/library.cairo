...
@storage_var
func ERC721_long_name_() -> (name: felt) {
}

@storage_var
func ERC721_long_symbol_() -> (symbol: felt) {
}

@storage_var
func ERC721_long_owners(token_id: Uint256) -> (owner: felt) {
}

@storage_var
func ERC721_long_balances(account: felt) -> (balance: Uint256) {
}

@storage_var
func ERC721_long_token_approvals(token_id: Uint256) -> (res: felt) {
}

@storage_var
func ERC721_long_operator_approvals(owner: felt, operator: felt) -> (res: felt) {
}

@storage_var
func ERC721_long_token_uri(token_id: Uint256) -> (token_uri: felt) {
}
...
func ERC721_initializer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC721_long_name_.write(name);
    ERC721_long_symbol_.write(symbol);
    // register IERC721
...
func ERC721_name{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    ...
    let (name) = ERC721_long_name_.read();
    return (name,);
}
...
func ERC721_symbol{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    ...
    let (symbol) = ERC721_long_symbol_.read();
    return (symbol,);
}
...
func ERC721_balanceOf{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (balance: Uint256) = ERC721_long_balances.read(owner);
    return (balance,);
}
...
func ERC721_ownerOf{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (owner) = ERC721_long_owners.read(token_id);
...
func ERC721_getApproved{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (approved) = ERC721_long_token_approvals.read(token_id);
    return (approved,);
}
...
func ERC721_isApprovedForAll{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (is_approved) = ERC721_long_operator_approvals.read(owner=owner, operator=operator);
    return (is_approved,);
}
...
func ERC721_tokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (token_uri) = ERC721_long_token_uri.read(token_id);
    return (token_uri,);
}
...
func ERC721_approve{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    if (caller == owner) {
        ...
        let (is_approved) = ERC721_long_operator_approvals.read(owner, caller);
...
func ERC721_setApprovalForAll{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC721_long_operator_approvals.write(owner=caller, operator=operator, value=approved);
...
func ERC721_mint{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    let (balance: Uint256) = ERC721_long_balances.read(to);
    let (new_balance: Uint256) = SafeUint256.add(balance, Uint256(1, 0));
    ERC721_long_balances.write(to, new_balance);
    ERC721_long_owners.write(token_id, to);
...
func ERC721_burn{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    ERC721_long_balances.write(owner, new_balance);

    // Delete owner
    ERC721_long_owners.write(token_id, 0);
...
func ERC721_setTokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC721_long_token_uri.write(token_id, token_uri);
    return ();
}
...
func _approve{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC721_long_token_approvals.write(token_id, to);
    let (owner) = ERC721_ownerOf(token_id);
...
func _exists{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (res) = ERC721_long_owners.read(token_id);
...
func _transfer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    // Decrease owner balance
    let (owner_bal) = ERC721_long_balances.read(_from);
    let (new_balance: Uint256) = SafeUint256.sub_le(owner_bal, Uint256(1, 0));
    ERC721_long_balances.write(_from, new_balance);

    // Increase receiver balance
    let (receiver_bal) = ERC721_long_balances.read(to);
...
func _check_onERC721Received{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    if (is_supported == TRUE) {
        let (selector) = IERC721_Receiver.onERC721Received(
            to, caller, _from, token_id, data_len, data
        );
